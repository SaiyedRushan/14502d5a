...
const AccordionTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className=''>
    <AccordionPrimitive.Trigger ref={ref} className={cn("flex w-full pt-4 transition-all hover:shadow-lg [&[data-state=open]>svg]:rotate-180 duration-200", className)} {...props}>
      {children}
